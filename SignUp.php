          ...
          <div class="content">
            ...
            <div class="form-group">
                <label class="control-label text-success" for="FullName">Middle Name</label>
                    <input class="form-control" data-val="true" required="" data-val-required="Middle name." id="FullName" name="m_name" placeholder="Middle Name" type="text" />
                <small class="field-validation-valid text-danger" data-valmsg-for="FullName" data-valmsg-replace="true"></small>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" data-val="true" minlength="12" maxlength="12" required="" name="u_aadhar" placeholder="Aadhar Number" pattern="[0-9]+" />
            ...
            <div class="form-group">
                <label class="control-label text-success" for="Password">Ration Card Number</label>
                <input class="form-control" data-val="true" required="" name="u_rationcard_number" placeholder="Ration Card Number" type="text" />
                <small class="field-validation-valid text-danger" data-valmsg-for="Password" data-valmsg-replace="true"></small>
            </div>
...
<div class="panel-footer">
    <a href="SignIn.php" class="btn btn-success p-l-md p-r-md font-bold" id="signupsubmitbtn">Already had an account?</a>
...
<?php
    ...
    while ($row1=mysqli_fetch_assoc($query1))
    {
      ...
      foreach ($coulmn as $value) 
      {
       ...
       if (strpos($u_aadhar, $value) !== FALSE ) 
       {
...
$query=mysqli_query($con,"insert into user (head_member_aadhar,u_aadhar,u_mobile,u_last_name,u_first_name,u_middle_name,u_dob,u_address,u_password,u_photo,u_gender,relation,u_income,rationcard_number) values ('$u_aadhar','$u_aadhar','$u_mobile','$l_name','$f_name','$m_name','$dob','$u_addr','$u_password','$dst1','$gender','Self','$income','$u_rationcard_number')") or die(mysqli_error($con));
