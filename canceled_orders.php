...
<table id="example" class="display nowrap table-bordered table-hover" cellspacing="0" width="100%">
        ...
        <th align="center">Canceled Date</th>
        <th align="center">Canceled Reason</th>
    ...
    <tbody>
      ...
      <?php
        ...
        $query="select * from tiffin_order where user_mob='".$_SESSION['user_mob']."' and order_status='Canceled' ORDER BY order_id DESC";
