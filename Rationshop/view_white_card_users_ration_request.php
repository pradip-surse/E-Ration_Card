...
$count=0;
//$query = mysqli_query($con,"select u.*,r.*,i.item_name,item_id from user u, user_ration_request r, item i where u.u_aadhar=r.u_aadhar and r.item_name=i.item_id and r.u_income='White' and r.ration_status-'Requested' ");

$query = mysqli_query($con,"select u.*, r.*, i.item_name,item_id from user_ration_request r, user u, item i where r.u_income='White' and r.ration_status='Requested' and r.item_name=i.item_id and r.u_aadhar=u.u_aadhar ");
