...
$query = mysqli_query($con,"select u.*, r.*, i.item_name,item_id from user_ration_request r, user u, item i where r.u_income='Yellow' and r.ration_status='Delivered' and r.item_name=i.item_id and r.u_aadhar=u.u_aadhar ");
