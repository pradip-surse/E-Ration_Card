...
{
  extract($_POST);
   $query='select * from admin where email="'.$_SESSION['email'].'" and password="'.$_POST['old_password'].'"';
   ...
   if(mysqli_num_rows($res)>0)
   {
         ...
         if($_POST['new_password']==$_POST['con_password'])
           {
          $updt = 'update admin set password="'.$_POST['new_password'].'" where email="'.$_SESSION['email'].'" ';
