        ...
        ?>
                    <tr>
                     ...
                     <td><!-- <a href="displayplace.php?id=<?=$id?>"><input type="button" value="View" class="btn btn-primary" /></a> -->
                              ...
                              <a data-toggle="tooltip" title="Approve" class="btn btn-success" href="set_approve_user.php?id=<?=$user_id?>&mobile=<?php echo $u_mobile; ?>"><i class="fa fa-lg fa-thumbs-up"></i></a>
