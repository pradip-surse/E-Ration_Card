...
?>
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i>Approved Rationshop List</h1>
          ...
          <div>
            <ul class="breadcrumb side">
              ...
              <li>Rationshop</li>
              <li class="active"><a href="#">View Approved Rationshop</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <?php
$count=0;
$query = mysqli_query($con,"select * from rationshop where r_status='Approved' ");
