...
<table id="example" class="display nowrap table-bordered table-hover" cellspacing="0" width="100%">
    ...
    <tbody>
      ...
      <?php
        ...
        $query="select * from tiffin_order where user_mob='".$_SESSION['user_mob']."' and order_status='Ordered' ORDER BY order_id DESC";
      ...
      <tr>
        ...
        <td align="center">
                    <a class="green" href="update_new_order.php?order_id=<?php echo $order_id; ?>" title="Update Order Information">
<i class="ace-icon glyphicon glyphicon-edit bigger-130"></i>
                    </a>
                    &nbsp;
                    
                    
                     <a class="red" onClick="return confirm('Are You Sure You Want To Cancel This Order ?');"  href="cancel_order.php?order_id=<?php echo $order_id; ?>" title="Cancel Order">
